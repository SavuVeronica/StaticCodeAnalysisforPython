...
const categories = ['fatal', 'error', 'warning', 'convention', 'refactor', 'information'];

export default function ExcludeCategoriesDialog({ onClose, onCancel, open }) {
...
ExcludeCategoriesDialog.propTypes = {
