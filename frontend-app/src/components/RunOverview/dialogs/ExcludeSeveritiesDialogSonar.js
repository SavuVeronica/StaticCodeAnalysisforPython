...
const categories = ['Blocker', 'Critical', 'Major', 'Minor', 'Info'];

export default function ExcludeSeveritiesDialogSonar({ files, onClose, onCancel, open }) {
...
ExcludeSeveritiesDialogSonar.propTypes = {
